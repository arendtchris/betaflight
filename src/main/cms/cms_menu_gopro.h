...
#define GOPRO_SETTING_BIT_DEPTH_ID 183
#define GOPRO_SETTING_FRAME_RATE_ID 184
#define GOPRO_SETTING_IMAGE_MODE_ID 185
#define GOPRO_SETTING_HDR_ID 186
#define GOPRO_SETTING_TIMELAPSE_ID 187
...
typedef enum {
    ...
    GOPRO_SETTING_BIT_DEPTH,
    GOPRO_SETTING_FRAME_RATE,
    GOPRO_SETTING_IMAGE_MODE,
    GOPRO_SETTING_HDR,
    GOPRO_SETTING_TIMELAPSE,
    GOPRO_SETTING_COUNT
} goproCmsSettingId_e;
